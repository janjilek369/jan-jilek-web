  ...
  return (
    ...
    >
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="grid grid-cols-1 min-[480px]:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 my-14 py-12 border-t border-b border-gray-300 dark:border-gray-700">
          {stats.map((item, i) => (
            <div key={i} className="text-left">
              <div className="font-serif text-[2rem] lg:text-[2.5rem] text-dark dark:text-white leading-[1.1] mb-2 tracking-tight">
                {item.number}
              </div>
              <div className="text-base text-gray-500 dark:text-gray-400 leading-snug">
                {item.label}
              </div>
            </div>
          ))}
        ...
        <div className="max-w-[720px] mt-8">
          <p className="text-lg text-gray-700 dark:text-gray-300 mb-4 leading-[1.8]">
